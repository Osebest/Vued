<template>
  <h1 class="text-4xl font-semibold">Welcome, Stranger! <span class="wave">👋</span></h1>
  <p class="my-8">
    This is a simple app that allows you view my Github profile, and that of other Github users as well.
    Added a counter app, in case your hands are itching 😎
  </p>

  <div class="flex gap-8 flex-wrap">
    <v-card class="mx-auto pb-2" width="350">
      <v-img
        ...
        lazy-src="https://picsum.photos/id/0/7/7" height="200px" cover>
      ...
      <v-card-subtitle>
        Check out my GitHub profile & search others!!!
      </v-card-subtitle>
    ...
    <v-card class="mx-auto pb-2" width="350">
      <v-img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8EuWYLZVudIip-wIJZJHgKGw5nRJlAtRxIw&usqp=CAU"
        lazy-src="https://picsum.photos/id/0/7/7" height="200px" cover>
        <template v-slot:placeholder>
          <div class="d-flex align-center justify-center fill-height">
            <v-progress-circular color="grey-lighten-4" indeterminate></v-progress-circular>
